                ...
                <div class="flex-1">
                    ...
                    <div class="mt-2">
                        <div class="grid grid-cols-1 gap-y-1">
                            ...
                            <p v-if="_get(product, 'toppings', '')" class="text-sm mb-0">
            ...
            <div v-if="product" class="flex gap-4">
                ...
                <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 gap-2 mt-2">
                        <div v-for="_product in product.combo && product.combo?.combo_products ? product.combo?.combo_products : []" :key="_product.id">
                            <h3 class="mb-0">
