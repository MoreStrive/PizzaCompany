...
export default {
  ...
  mailerTransporter: {
    ...
    secure: false,
    auth: {
      user: process.env.GMAIL_USERNAME || 'thethongminhgensi@gmail.com',
      pass: process.env.GMAIL_PASSWORD || 'aolkreztzushccdv',
    },
  },
  redis: {
  ...
  s3: {
    credentials: {
      accessKeyId: process.env.S3_ACCESS_KEY || '1Q6TIOBC1HUZBDFNXZH6',
      secretAccessKey: process.env.S3_SECRET_KEY || 'oTO9ee5RaehI6ShwawEUt6CzesRg7sikrEXXRQj2',
    },
    endpoint: process.env.S3_ENDPOINT || 's3.ap-northeast-1.wasabisys.com',
    region: process.env.S3_REGION || 'ap-northeast-1',
    params: {
      ACL: 'public-read',
      Bucket: process.env.S3_BUCKET_NAME || 'image-storage',
    },
